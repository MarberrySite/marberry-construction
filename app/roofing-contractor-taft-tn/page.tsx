...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/roofing-contractor-taft-tn' },
};
...
const faqItems = [
  ...
  {
    question: 'How much does a standing seam roof cost near Taft?',
    answer:
    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-slate-600 text-base leading-relaxed mb-4">
            Standing seam metal roofing in the Taft and southern Lincoln County area typically runs $1000 to $1300 per square installed, depending on the profile and gauge. The price includes tear-off, disposal, new underlayment, materials, and labor. Pitch, access, and roof complexity all affect the final number.
          </p>
          <p className="text-slate-600 text-base leading-relaxed mb-4">
