    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-slate-600 text-base leading-relaxed mb-4">
            The custom home process typically starts 3 to 4 weeks before we get started on the foundation. That time is spent finalizing plans, running soil tests if needed, and securing financing. Building permits in our Tennessee service area (Lincoln, Giles, and Franklin counties) are usually same-day. In our Alabama service area (Madison and Limestone counties), building permits typically take 1 to 2 weeks.
          </p>
          <p className="text-slate-600 text-base leading-relaxed mb-4">
